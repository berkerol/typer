...
A tower defense like typing game. Characters can be case sensitive or insensitive. Wrong characters decrease the score. Click button to change case sensitivity. Written according to the [latest ECMAScript Specification](https://www.ecma-international.org/ecma-262/).
